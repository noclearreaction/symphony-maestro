...
- Create a production-grade Go project for Rubato under `tools/rubato/` using a standard layout with `cmd/`, `internal/`, `pkg/`, and `test/`.
...
- Affected systems: `tools/rubato/` source layout, local build/test workflow, proxy runtime entrypoint.
