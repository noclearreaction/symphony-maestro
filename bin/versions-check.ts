#!/usr/bin/env -S deno run --allow-run=docker --allow-env=GH_TOKEN,COMPOSE_PROJECT_NAME,LOCAL_WORKSPACE_FOLDER
...
//   --github-token=<t>   GitHub token for API lookups (overrides $GH_TOKEN)
...
const githubToken = githubTokenArg?.slice("--github-token=".length)
